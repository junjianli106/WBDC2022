...
def parse_args():
    ...
    parser.add_argument("--split_seed", type=int, default=2022, help="random seed for split.")

    parser.add_argument('--dropout', type=float, default=0.3, help='dropout ratio')
    parser.add_argument("--tune", type=int, default=0, help="tune parameter")

    # ========================= Data Configs ==========================
    parser.add_argument('--train_annotation', type=str, default='data/annotations/labeled.json')
    parser.add_argument('--val_annotation', type=str, default='')
    ...
    parser.add_argument('--only_train', default=0, type=int, help="no valid")


    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='save/v1')
    parser.add_argument('--ckpt_file', type=str, default='save/v1/model_epoch_4_mean_f1_0.5878.bin')
    ...
    parser.add_argument('--warmup_steps', default=-1, type=int, help="warm ups for parameters not in bert or vit")
    ...
    parser.add_argument('--pretrain', type=int, default=0, help='How many epochs')
    parser.add_argument('--pool', type=str, default='cls', help='How many epochs')
    parser.add_argument('--pool_dropout', default=0.1, type=float, help="warm ups for parameters not in bert or vit")


    parser.add_argument("--mlm_co", default=1.0, type=float, help="Weight deay if we apply some.")
    parser.add_argument("--itm_co", default=1.0, type=float, help="Weight deay if we apply some.")
    parser.add_argument("--mfm_co", default=1.0, type=float, help="Weight deay if we apply some.")

    parser.add_argument('--outraw', default=0, type=int)

    parser.add_argument("--weight_decay", default=0.01, type=float, help="Weight deay if we apply some.")
    parser.add_argument("--adam_epsilon", default=1e-6, type=float, help="Epsilon for Adam optimizer.")
    parser.add_argument('--fgm', type=int, default=0,
                        help='whether to use fgm')
    parser.add_argument('--text_fgm_eps', type=float, default=0.1,
                        help='fgm eps')
    parser.add_argument('--img_fgm_eps', type=float, default=0.1,
                        help='fgm eps')
    parser.add_argument('--pgd', type=int, default=0,
                        help='whether to use pgd')
    parser.add_argument('--text_pgd_alpha', type=float, default=0.5,
                        help='fgm eps')
    parser.add_argument('--img_pgd_alpha', type=float, default=0.5,
                        help='fgm eps')
    ...
    parser.add_argument('--model_type', type=str, default='vbert')
