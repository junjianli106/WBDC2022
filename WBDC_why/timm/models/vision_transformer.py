...
class VideoTransformer(nn.Module):
    ...
    def __init__(
            self, embed_dim=768, max_frames=32, depth=12, num_heads=12, mlp_ratio=4., qkv_bias=True, init_values=None,
        ...
        self.pos_embed = nn.Parameter(torch.randn(1, max_frames, embed_dim) * .02)
        self.pos_drop = nn.Dropout(p=drop_rate)
