...
class VLBertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        #vis_token_type_ids = torch.ones(visual_input_shape, dtype=torch.long, device=device)
        ...
        vis_embedding_output = self.embeddings(
            inputs_embeds=visual_embeds,
            token_type_ids=visual_token_type_ids
        )
        embedding_output = torch.cat([embedding_output, vis_embedding_output], 1)
