...
def parse_args():
    ...
    parser.add_argument('--train_unlabeled', type=str, default='../challenge/data/annotations/unlabeled.json')
    parser.add_argument('--test_annotation', type=str, default='../challenge/data/annotations/test_b.json')
    ...
    parser.add_argument('--train_zip_nolabels_feats', type=str, default='../challenge/data/zip_feats/unlabeled.zip')
    parser.add_argument('--test_zip_feats', type=str, default='../challenge/data/zip_feats/test_b.zip')
    parser.add_argument('--test_output_csv', type=str, default='data/result_mlm_itm_fold20.csv')
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='save/Unibert/baseline_fgm1.5_ema_pretreain_3_mlm_itm')
    parser.add_argument('--ckpt_file', type=str, default='Unibert_f1_0.6815_fold_0.bin')
    ...
    # ========================== Title BERT =============================
    parser.add_argument('--bert_dir', type=str, default='./new_self_pretrained_model_record/chinese-roberta-wwm-ext-e10_10_1_110W_mlm_itm/')
    ...
    parser.add_argument('--fgm', type=bool, default=True, help='fgm')
    parser.add_argument('--pgd', type=bool, default=False, help='pgd')
    parser.add_argument('--start_fold', default=0, type=int, help="resume training")
    parser.add_argument('--only_training', type=bool, default=False, help='only train without validation')
